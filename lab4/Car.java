public class Car extends Auto{  // файл Car.java
    ...
    public Car(String firma, int speed, String name, String carNumber, int n, Boolean f) {
        super(firma, speed, carNumber);  // вызываем конструктор класса-родителя с параметрами (см. класс Auto) 
