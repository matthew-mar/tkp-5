...
public class Truck extends Auto {
    ...
    public Truck(String firma, int speed, String name, String carNumber, int n, Boolean f) {
        super(firma,speed, carNumber);
        model = name;
        power = n;
        trailer = f;
    }
    ...
    public void setAllInfo() { 
        ...
        String nazv=in.next(); //метод next() позволяет вводить строки, но без пробелов setFirm(nazv);
